...
namespace FinalTestProject.Models.Accounts
{
	...
	{
		public List<OgretimElemani> ogretimElemaniList = new List<OgretimElemani>();
		public List<Ders> DersListe = new List<Ders>();
		public List<Ders> acilanDersler = new List<Ders>();
		...
		{
			this.acilanDersler.Remove(ders);
		}
